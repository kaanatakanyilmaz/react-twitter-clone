  ...
  return (
    <Popover className="relative">
      <PopoverButton className=" flex items-center py-[3px] outline-none">
        <button>
          <div className="inline-flex items-center  text-[color:var(--color-base)] hover:bg-[color:var(--hover-base)] p-3 rounded-full gap-5 transition-colors">
      ...
      <PopoverPanel className="w-[318px]   absolute bottom-0 text text-[color:var(--color-base)] bg-[color:var(--background-primary)] shadow-box rounded-xl">
        <div>
          <Link
            to="list"
            className=" h-14 w-full inline-flex items-center hover:bg-[#29454d1a] p-4 rounded-xl gap-5 transition-colors"
          >
            <div className="w-[26.25] h-[26.25] ">
              <button>
                <div>
            ...
            <div className=" text-xl pr-4 font-bold">Listeler</div>
          </Link>
          ...
          <Link
            to="https://ads.x.com/onboarding/18ce55qqxh7/welcome?ref=gl-tw-tw-twitter-ads-rweb"
            target="_blank"
          ...
          >
            ...
            <div className=" text-xl pr-4 font-bold">İşler</div>
          </button>
          <button
          ...
          >
            ...
            <div className=" text-xl pr-4 font-bold">Premium</div>
          </button>
          <button
            onClick={() => setModal("verifiedmodal")}
            className=" h-14 w-full inline-flex items-center hover:bg-[#eff3f41a] p-4 rounded-xl gap-5 transition-colors"
          >
            <div className="w-[26.25] h-[26.25] ">
              <button>
            ...
            <div className=" text-xl pr-4 font-bold">Onaylı Kuruluşlar</div>
          </button>
          <button
            className=" h-14 w-full inline-flex items-center hover:bg-[#eff3f41a] p-4 rounded-xl gap-5 transition-colors"
            onClick={() => setModal("chatroom")}
          >
            <div className="w-[26.25] h-[26.25] ">
              <button>
                <div>
