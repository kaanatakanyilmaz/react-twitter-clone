...
function More() {
    ...
    return (
        <Popover className="relative">
            <Popover.Button className=" flex items-center  py-[3px] outline-none">
                <button>
            ...
            <Popover.Panel className="w-[318px]  absolute bottom-0  bg-black shadow-box rounded-xl ">
                <div className="  ">
                    ...
                    <button className=" h-14 w-full inline-flex items-center hover:bg-[#eff3f41a] p-4 rounded-xl gap-5 transitions-colors">
                        <div className="w-[26.25] h-[26.25] relative">
                            <svg viewBox="0 0 24 24" width={26.25} height={26.25}>
                    ...
                    <button className=" h-14 w-full inline-flex items-center hover:bg-[#eff3f41a] p-4 rounded-xl gap-5 transitions-colors">
                        <div className="w-[26.25] h-[26.25] relative">
                            <svg viewBox="0 0 24 24" width={26.25} height={26.25}>
                                ...
                                <path fill="#e7e9ea" d="M8.75 21V3h2v18h-2zM18 21V8.5h2V21h-2zM4 21l.004-10h2L6 21H4zm9.248 0v-7h2v7h-2z" />
                            </svg>
                    ...
                    <button className=" h-14 w-full inline-flex items-center hover:bg-[#eff3f41a] p-4 rounded-xl gap-5 transitions-colors">
                        <div className="w-[26.25] h-[26.25] relative">
                            <svg viewBox="0 0 24 24" width={26.25} height={26.25}>
                                ...
                                <path fill="#e7e9ea" d="M1.996 5.5c0-1.38 1.119-2.5 2.5-2.5h15c1.38 0 2.5 1.12 2.5 2.5v13c0 1.38-1.12 2.5-2.5 2.5h-15c-1.381 0-2.5-1.12-2.5-2.5v-13zm2.5-.5c-.277 0-.5.22-.5.5v13c0 .28.223.5.5.5h15c.276 0 .5-.22.5-.5v-13c0-.28-.224-.5-.5-.5h-15zm8.085 5H8.996V8h7v7h-2v-3.59l-5.293 5.3-1.415-1.42L12.581 10z" />
                            </svg>
