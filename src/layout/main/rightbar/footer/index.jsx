  ...
  return (
    <div className=" flex flex-wrap  px-4 mt-4 ">
      <Link
        ...
        className="my-0.5 pr-3 hover:underline text-[#71767b] text-[13px] leading-4"
      >
        Hizmet Şartları
      </Link>
      <Link
      ...
      <div className="w-full">
        <Popover className=" relative leading-4 inline-flex">
          <PopoverButton className=" text-[#71767b] text-[13px] leading-4 outline-none hover:underline flex items-center  ">
          ...
          <PopoverPanel className="w-[176px] max-w-[384px] absolute bottom-0 right-0 bg-black  shadow-box rounded-xl flex flex-col overflow-hidden">
            <Link
              to="https://about.x.com/tr"
              className="px-4 py-3 text-[#fff] text-[15px] leading-5 font-bold hover:bg-[#16181c] transition-colors"
            >
              Hakkında
            </Link>
            <Link
