...
function Search() {
  ...
  return (
    <div
      ref={ref}
      className="h-[53px] mb-3 flex items-center sticky top-0 bg-[color:var(--background-primary)] z-[1]"
    >
      <label className="h-[44px]  rounded-full bg-[color:var(--background-primary)] outline-none relative w-full border border-[color:var(--border-primary)]  group focus-within:bg-black focus-within:border-[#1d9bf0]">
      ...
      {focus && (
        <div className="absolute w-[350px] top-full -left-px -translate-y-1  bg-[color:var(--background-primary)] border border-[color:var(--border-primary)] shadow-box max-h-[calc(80vh-53px)] rounded-lg text-center min-h-[100px]">
          <p className="pt3 pt-5 text-[#71767b] leading-5 text-[color:var(--color-base-secondary)]">
